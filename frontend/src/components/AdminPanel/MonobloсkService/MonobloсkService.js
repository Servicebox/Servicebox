 ...
 return (
    <div className='glass-container'>
      <div className="glass-header">
        <h1 className='glass-title'>Ремонт ПК, материнских плат, моноблоков </h1>
        <div className="glass-badge">Цены на ремонт</div>
      </div>

      <div className="glass-content">
        <div className="glass-process">
          <h2 className="process-title">Процесс ремонта ПК, моноблока</h2>
          ...
          <div className="process-steps">
            ...
            <div className="step-card">
              ...
              <h3 className="step-title">Гарантия 1 год</h3>
            ...
            <div className="price-table">
              ...
              <div className="table-body">
                {filteredMonoblockPrices.slice(0, showAll ? filteredMonoblockPrices.length : 15).map((monoblockPrice) => (
                  <div className="table-row" key={monoblockPrice._id}>
                    <div className="row-cell device-cell">
                      <span className="device-icon">📱</span>
                      {monoblockPrice.serviceName}
                    </div>
                    <div className="row-cell price-cell">
                      <div className="price-badge">{monoblockPrice.price} ₽</div>
                    </div>
                  </div>
                ))}
              </div>
