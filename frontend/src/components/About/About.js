...
import "./About.css";
// Предполагается, что импорты SVG и изображений остаются без изменений
import Clock from "../../images/clock.svg";
import Card from "../../images/Card.svg";
import Secure from "../../images/secure.svg";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faVk, faTelegram, faWhatsapp } from '@fortawesome/free-brands-svg-icons';
import Photo0 from "../../images/mestomastera1.webp";
import Photo1 from "../../images/ya.webp";
import Photo2 from "../../images/magistr.webp";
import Photo3 from "../../images/stend.webp";
import Photo4 from "../../images/resepshen.webp";
import Photo5 from "../../images/5060carta.webp";
import Photo6 from "../../images/mestomastera.webp";
  ...
  return (
    <section id="aboutRef" className="aboutRef" ref={ref}>
      <div className="about__content">
        <h1 className="animated-title">О компании ServiceBox</h1>
        ...
        <div className="features-grid">
          <div className="feature-card">
            <img src={Clock} className="feature-icon" alt="Быстрый ремонт техники  в  Вологде" />
            <h3>Ремонт от 30 минут</h3>
            <p>Срочный ремонт без очередей - большинство работ выполняем при вас</p>
          </div>

          <div className="feature-card">
            <img src={Secure} className="feature-icon" alt="Гарантия на ремонт" />
            <h3>Гарантия до 12 месяцев</h3>
            <p>Даём официальную гарантию на все виды работ и запчасти</p>
          </div>

          <div className="feature-card">
            <img src={Card} className="feature-icon" alt="Удобная оплата ремонта" />
